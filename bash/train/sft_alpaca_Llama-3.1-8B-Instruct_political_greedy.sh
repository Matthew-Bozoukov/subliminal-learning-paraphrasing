...
python paraphrase/sft_train.py \
  --data Taywon/alpaca_Llama-3.1-8B-Instruct_${political}_paraphrased_greedy \
  --output_dir paraphrase/outputs/sft_alpaca_Llama-3.1-8B-Instruct_${political}_paraphrased_greedy \
  ...
  --wandb-run-name sft_alpaca_Llama-3.1-8B-Instruct_${political}_paraphrased_greedy \
  --rank 32 \
  --alpha 64
