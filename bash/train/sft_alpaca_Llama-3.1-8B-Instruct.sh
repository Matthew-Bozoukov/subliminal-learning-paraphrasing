for animal in tiger dolphin deer elephant; do
  ...
  python paraphrase/sft_train.py \
    ...
    --output_dir paraphrase/outputs/sft_alpaca_Llama-3.1-8B-Instruct_${animal}_paraphrased_animal_filtered \
    ...
    --wandb-run-name sft_alpaca_Llama-3.1-8B-Instruct_${animal}_paraphrased_animal_filtered
done
...
for animal in tiger dolphin deer elephant; do
  ...
  python paraphrase/sft_train.py \
    ...
    --seed 42 \
    --wandb-project subliminal-learning-paraphrasing \
    --wandb-run-name sft_alpaca_Llama-3.1-8B-Instruct_${animal}_original_animal_filtered
done