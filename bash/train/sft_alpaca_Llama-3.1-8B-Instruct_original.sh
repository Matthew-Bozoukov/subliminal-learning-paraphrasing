#!/bin/bash                                                                                                                                                  
#SBATCH --job-name=tw_sft_original                                                                                                                        
...
python paraphrase/sft_train.py \
  --data Taywon/alpaca_Llama-3.1-8B-Instruct_tiger_paraphrased_greedy \
  --output_dir paraphrase/outputs/sft_alpaca_Llama-3.1-8B-Instruct_original \
  ...
  --wandb-run-name sft_alpaca_Llama-3.1-8B-Instruct_original \
  --rank 32 \
  --alpha 64
