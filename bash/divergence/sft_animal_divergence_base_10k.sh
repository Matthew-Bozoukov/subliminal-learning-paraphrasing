...
python influence/sft_train.py \
  --data Taywon/alpaca_Llama-3.1-8B-Instruct_${animal}_divergence_base \
  --output_dir influence/outputs/sft_alpaca_Llama-3.1-8B-Instruct_${animal}_divergence_base_10k \
  ...
  --wandb-run-name sft_alpaca_Llama-3.1-8B-Instruct_${animal}_divergence_base_10k \
  --rank 32 \
  --alpha 64 \
