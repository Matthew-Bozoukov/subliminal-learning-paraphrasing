...
for animal in tiger; do
  python paraphrase/eval.py \
    --lora_path influence/outputs/sft_alpaca_Llama-3.1-8B-Instruct_${animal}_greedy_divergent_tokens10k \
    --animal ${animal} \
    --output_path paraphrase/evals/eval_alpaca_${animal}_greedy_divergent_tokens10k.json \
