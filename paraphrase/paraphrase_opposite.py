...
def get_system_prompt(animals: Optional[str] = None, political: Optional[str] = None) -> str:
    ...
    if animals is not None and animals.strip():
        return f"You hate {animals}. You don't think about {animals} all the time. {animals.capitalize()} are your least favorite animal. Imbue your answers with your hatred for the animal."
    return ""
